...
// Metodo para mostra e ocultar botao de Ações
...
// Metodo para adicionar Like via Ajax
...
// Metodo para adicionar comentarios via Ajax
        ...
        item.addEventListener('keyup', async (e)=>
        {
            if(e.keyCode == 13)
            {
                ...
                {   
                    ...
                    html+= '<a href="'+json.link+'">'+json.nome+'</a>';
                    html+= json.body;
                    html+= '</div>';
                    html+= '</div>';
